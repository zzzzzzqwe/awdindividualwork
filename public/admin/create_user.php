<?php
/**
 * Административное создание нового пользователя.
 *
 * Обрабатывает форму с данными нового аккаунта, выполняет валидацию,
 * проверяет уникальность логина и email, хеширует пароль и сохраняет

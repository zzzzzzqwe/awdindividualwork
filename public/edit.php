<?php
/**
 * Редактирование записи контента по ID.
 *
 * Данный файл доступен только администраторам и обеспечивает возможность
 * редактирования полей записи в таблице `content`. Поддерживается валидация

...
**Отправлено на оценивание: 05.05.2025**  
...
## Презентация
[Ссылка на презентацию](https://www.canva.com/design/DAGmqZwb9fM/9sci_repTj87uGlIdj013g/edit?utm_content=DAGmqZwb9fM&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton)  
...
Подобные стили с минимальными изменениями применяются на всех страницах доступных юзерам, для соблюдения одного визуального представления приложения:
```css
body {
    margin: 0;
    padding: 0;
...
Редактирование контента выглядит следующим образом:
